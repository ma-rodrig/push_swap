...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/28 02:26:09 by marodrig          #+#    #+#             */
/*   Updated: 2025/01/29 01:29:11 by marodrig         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_set_target_a(t_stack_node *a, t_stack_node *b)
{
...
static void	ft_cost_analysis_a(t_stack_node *a, t_stack_node *b)
{
	int	len_a;
	int	len_b;
